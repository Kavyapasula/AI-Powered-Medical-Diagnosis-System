...
st.markdown(
    ...
    input, select, textarea {
        ...
        background-color: #1E1E2E !important;  /* Dark Blue */
        border: 2px solid #D4A5FF !important;  /* Light Purple */
    }
...
if selected == 'Diabetes Prediction':
    ...
    st.markdown("<h3 style='color: orange;'>Enter the following details to predict diabetes:</h3>", unsafe_allow_html=True)
...
if selected == "Lung Cancer Prediction":
    ...
    #st.markdown("<h3 style='color: cyan;'>Enter the following details to predict thyroid disease:</h3>", unsafe_allow_html=True)
